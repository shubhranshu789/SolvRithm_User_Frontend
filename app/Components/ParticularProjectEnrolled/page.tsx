...
export default function ProjectPage() {
    ...
    useEffect(() => {
        ...
        const fetchGithub = async () => {
            try {
                ...
                console.error("Error fetching GitHub link", err);
            }
        };
    ...
    const handleUpload = async () => {
        try {
            ...
            const data = await res.json();
            if (res.ok) {
                alert("GitHub link uploaded successfully!");
                setGithubLink("");
            } else {
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 p-3 ring-1 ring-white/10 backdrop-blur-xl">
                                        <h3 className="text-2xl font-semibold tracking-tight text-white md:text-2xl">Google form</h3>
                                        {data.googleForm ? (
